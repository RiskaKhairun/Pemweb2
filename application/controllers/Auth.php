...
class Auth extends CI_Controller {
    ...
    private function _sendEmail($token, $type) {
        $config = [
            ...
            'smtp_user' => 'riska.khairun.anisa@mhs.politala.ac.id',
            'smtp_pass' => 'aeay kbcl svoc cnvk',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('riska.khairun.anisa@mhs.politala.ac.id', 'aeay kbcl svoc cnvk');
